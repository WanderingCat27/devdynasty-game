...
public class Inventory extends Sprite {
  ...
  public static Item remove(int index) {
    ...
    if (index >= itemsInInventory.size())
      return null;
    
      itemsInInventorySprites.remove(index);
      return itemsInInventory.remove(index);
  }

  // This will track which key is pressed and set the keyNumber to the
  // corresponding number to be used in the draw function
  ...
  public static void addNPC(Item item) {
