...
public class BlueDinoScript extends Script<NPC> {
    ...
    protected void setup() {
        ...
        if (GlobalFlagManager.FLAG_MANAGER.isFlagSet("hasTalkedToCaveman2") && !GlobalFlagManager.FLAG_MANAGER.isFlagSet("dinoDefeated")) {
            showTextbox();
    ...
    protected void cleanup() {
        if (GlobalFlagManager.FLAG_MANAGER.isFlagSet("hasTalkedToCaveman2"))
            GlobalFlagManager.FLAG_MANAGER.setFlag("hasTalkedToBlueDino");
        unlockPlayer();
        hideTextbox();
    }
