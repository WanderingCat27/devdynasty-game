...
public class ImageLoader {
  ...
  // loads an image and sets its transparent color to the one defined in the
  // Config class
  ...
  // loads a piece of an image from an image file and sets its transparent color
  // to the one defined in the Config class
  ...
  // loads a piece of an image from an image file and allows the transparent color
  // to be specified
  public static BufferedImage loadSubImage(String imageFileName, Color transparentColor, int x, int y, int width,
      int height) {
    try {
      BufferedImage initialImage = ImageIO.read(new File(Config.RESOURCES_PATH + imageFileName));
  ...
  public static BufferedImage loadAllowTransparent(String imageFileName) {
    try {
