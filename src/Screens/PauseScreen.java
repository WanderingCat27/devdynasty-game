...
public class PauseScreen extends Screen {
  ...
  protected TextButton resetTutorialsButton;
  ...
  public void initialize() {
    ...
    playButton = new AnimatedSpriteButton(0, -110, 6,
        new SpriteSheet(ImageLoader.loadAllowTransparent("resume_button.png"), 48, 26), () -> {
    ...
    if (volumeSlider == null) {
      ...
      volumeSlider.addChangeListener(() -> {
        ...
        if (CombatScreen.combatSoundPlayer != null)
          CombatScreen.combatSoundPlayer.setVolume((int) volumeSlider.getValue());
  ...
  public void draw(GraphicsHandler graphicsHandler) {
    ...
    resetTutorialsButton.draw(graphicsHandler);
  }

  private float getScaleFactor() {
    return Math.max(1, Math.min((float) ScreenManager.getScreenHeight() / Config.GAME_WINDOW_HEIGHT,
        (float) ScreenManager.getScreenWidth() / Config.GAME_WINDOW_WIDTH));
  }
